...
const Footer = () => {
  return (
    <div>
      <footer className="text-white body-font bg-gray-900 flex items-center justify-center pb-8" >
        <div className="flex flex-1 pt-[4.5rem] flex-wrap max-w-[90rem] lg:px-20  md:px-10  px-5 md:flex-nowrap">
          <div className="">
            ...
            <p className='font-normal text-sm opacity-40 mix-blend-normal  md:mt-24 mt-10 mb-10 '>© 2019 Designed by Cr8tiv_yemmy</p>
          </div>
