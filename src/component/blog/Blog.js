...
function Blog() {
   ...
   text-transparent bg-clip-text">
            ...
            <div className="  pt-[6rem] flex justify-center items-center sm:mx-[5rem] mx-12 ">
                ...
                <div className=" transform max-lg:w-[80%] max-sm:w-[300px] scale-125 z-20 bg-white shadow-xl border-fuchsia-800 border px-8 sm:pl-[3.7rem] sm:pr-[3.3rem] pb-10  pt-10  rounded-lg overflow-hidden text-center ">
                    ...
                    <div className='sm:gap-5 gap-3'>
                        <h1 className="sm:text-xl bg-gradient-to-b from-[#C35B95] to-[#B254AB]
               text-transparent bg-clip-text    text-xs text-left font-bold  sm:mt-3 mb-[0.9rem]">
